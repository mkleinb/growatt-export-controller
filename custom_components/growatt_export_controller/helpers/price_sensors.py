...
_QUARTER_HINTS = ("quarter", "quarter-hour", "quarter hourly", "kwartier", "15 min", "15min")
_NON_CURRENT_HINTS = (
    "tomorrow",
    "morgen",
    "next",
...
def _score_state(state: State) -> PriceSensorCandidate | None:
    ...
    if _has_any(searchable, _QUARTER_HINTS):
        score += 35
        reasons.append("quarter-hour current price")
